...
contains
    ...
    subroutine mcmc_bayesCpi_init(config, gdata, mstate, mstore)
    ...
    end subroutine mcmc_bayesCpi_init

    subroutine mcmc_bayesCpi_kernel(config, gdata, mstate, mstore)
        ...
        do j = 1, config%ncat
            ...
            do k = 1, gdata%nloci
                ...
                if (gdata%C(snploc, j) == 1) then
                    ...
                    if (gdata%snptracker(snploc, j) > 1) then
        ...
        do j = 1, config%ncat
            do i = 1, gdata%nloci
                if (gdata%snptracker(i, j) > 1) then
    ...
    end subroutine mcmc_bayesCpi_kernel

end module mod_mcmc_bayesCpi
